jQuery(function($) {
    ...
    $(window).load(function() { // makes sure the whole site is loaded
        ...
        $("#nav-main ul li a").mPageScroll2id({highlightClass: "current-menu-item"});
    ...
    $(document).ready(function() {
        ...
        $('.counting').counterUp({delay: 5, time: 1000});
        // Featured Slider
        ...
        owl.owlCarousel({
            ...
            itemsDesktop: [
                1280, 3
            ], //3 items between 1280px and 991px
            itemsTablet: [
                991, 2
            ], //2 items between 991 and 600
            itemsMobile: [
                600, 1
        ...
        // Testimonial Slider
        var owl = $("#owl-tm");
        owl.owlCarousel({singleItem: true, autoPlay: 5000, stopOnHover: true});
        // Parallax Effects
        ...
        // Mailchimp
        $('#mc-form').ajaxChimp({url: 'http://jadeallencook.us11.list-manage.com/subscribe/post?u=6ec2b4f8532e1da1faed16898&amp;id=1598d2d240'});
    });

    (function() {
        $(window).on('scroll', function() {
            if ($(window).scrollTop() > 25) {
                $(".okayNav li a, .navbar-brand").css({'padding-top': '20px'});
                $(".navbar-default").css({'background-color': 'rgba(255, 255, 255, 1)'});
                $(".navbar-default .okayNav li a").css({color: '#636466'});
                $(".navbar-default").css({'margin-top': '0px'});
                $(".okayNav__menu-toggle").css({'top': '28px', 'transition': 'all 1s linear 0s'});
                $('div.navbar img').attr('src', 'assets/img/ui/logo.png');
            } else {
                $(".okayNav li a, .navbar-brand").css({'padding-top': '20px'});
                $(".navbar-default .okayNav li a").css({color: '#fff'});
                $(".navbar-default").css({'background-color': 'transparent', 'border': '0px solid #ddd'});
                $(".okayNav__menu-toggle").css({'top': '58px', 'transition': 'all 1s linear 0s'});
